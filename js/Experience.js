...
function displaycard(){
    ...
    experienceCard.forEach(({title ,desc,date, Tool}) =>{
        ...
        <div class="border border-gray-300 p-6 rounded-lg hover:bg-blue-500 transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-11">
          ...
          <p class="leading-relaxed text-gray-900 text-base">${desc}${date}<br>${Tool}</p>
        </div>
      </div>`
