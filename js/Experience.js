...
var experienceCard = [
    {
        ...
        desc:'',
        date: '10-10-2020 - 07-12-2020 ',
        Tool: 'Tool Used: Wordpress'
    },
    {
        title: 'Web Developer | Verzeo',
        desc:'',
        date: '1-12-2019 - 31-1-2020 ',
...
function displaycard(){
    ...
    experienceCard.forEach(({title ,desc,date, Tool}) =>{
        ...
        <div class="border border-gray-300 p-6 rounded-lg hover:bg-green-500 transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-11">
          ...
          <p class="leading-relaxed text-base">${desc}${date}<br>${Tool}</p>
        </div>
      </div>`
